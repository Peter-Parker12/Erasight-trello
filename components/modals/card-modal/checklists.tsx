    ...
    <div className="space-y-4">
        ...
        return (
          <div key={checklist.id}>
            <div className="flex items-center gap-x-3 mb-2">
              <CheckSquare className="h-5 w-5 text-neutral-700 shrink-0" />
              <div className="flex-1 flex items-center justify-between">
                <p className="font-semibold text-neutral-700">{checklist.title}</p>
                <Button
                  variant="ghost"
                  size="sm"
            ...
            <div className="flex items-center gap-2 ml-8 mb-2">
              ...
              <div className="flex-1 bg-gray-200 rounded-full h-2">
                <div
                  className={cn("h-2 rounded-full transition-all", percent === 100 ? "bg-green-500" : "bg-sky-600")}
                  style={{ width: `${percent}%` }}
                />
              </div>
            </div>
            ...
            <div className="ml-8 space-y-1">
              ...
              {addingId === checklist.id ? (
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-sm text-muted-foreground hover:text-neutral-700 mt-1 py-0.5"
                >
      ...
      {showNewChecklist ? (
        <div className="flex items-start gap-x-3">
          <CheckSquare className="h-5 w-5 mt-1 text-neutral-700 shrink-0" />
