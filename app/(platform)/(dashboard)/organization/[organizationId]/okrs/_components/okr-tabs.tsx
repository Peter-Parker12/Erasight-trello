        ...
        .map((tab) => {
          ...
          return (
            <Link
              ...
              href={tab.href}
              className={cn(
                "flex items-center gap-x-1.5 whitespace-nowrap px-3 py-2 text-sm font-medium border-b-2 border-transparent text-neutral-500 hover:text-neutral-800 transition",
