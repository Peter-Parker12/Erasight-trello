...
const METHOD_STYLES = {
  ...
  POST: "bg-violet-950 text-violet-400 border-violet-800",
    ...
    return (
      <div className="space-y-6">
        <div className="space-y-1">
          <h2 className="text-lg font-semibold text-[#e5e5e5] capitalize">{tab} API</h2>
        ...
        <div className="border rounded-md overflow-hidden divide-y text-xs">
          <div className="grid grid-cols-4 p-2.5 bg-[#111] font-semibold text-muted-foreground">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Query params:{" "}
            <code className="text-violet-300">q</code> (search term, case-insensitive),{" "}
            <code className="text-violet-300">limit</code> (1–100, default 50),{" "}
            <code className="text-violet-300">offset</code> (default 0).
          ...
          <div className="border rounded-md overflow-hidden divide-y">
            ...
            {customFlds.map((f) => (
              <div key={f.id} className="grid grid-cols-4 p-2.5 text-xs text-muted-foreground bg-[#1c1c1f]/20">
                ...
                <div className="col-span-1 text-violet-400">Custom field</div>
              </div>
            ))}
            {customFlds.length === 0 && (
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <div className="md:col-span-3 space-y-6">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                <code className="text-violet-300">Authorization</code> header.
              </p>
            </div>
            ...
            <div className="rounded-md border p-4 bg-[#111] space-y-3">
              ...
              <div className="bg-black/40 p-2.5 rounded border border-[#222] font-mono text-xs text-[#a9b1d6]">
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-[#e5e5e5]">Base URL</h3>
              <div className="bg-[#111] p-3 rounded border font-mono text-xs text-violet-400">
                {baseUrl}/api/v1
              </div>
            </div>

            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-[#e5e5e5]">Available Resources</h3>
              <div className="border rounded-md overflow-hidden divide-y text-xs">
                <div className="grid grid-cols-4 p-2.5 bg-[#111] font-semibold text-muted-foreground">
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-[#e5e5e5]">HTTP Status Codes</h3>
        ...
        {activeTab === "schema" && (
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-lg font-semibold text-[#e5e5e5]">Schema API</h2>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="rounded-md border p-4 bg-[#111] space-y-2">
              ...
              <pre className="font-mono text-[11px] text-[#888] overflow-x-auto">{`{
  "data": {
    "entityType": "COMPANY",
    "fields": [
    ...
    "pipelineStages": [
      ...
      { "id": "uuid...", "name": "Closed Won",  "order": 3, "isWon": true,  "isLost": false }
        ...
        {activeTab === "openapi" && (
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-lg font-semibold text-[#e5e5e5]">OpenAPI 3.0 Spec</h2>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-[#e5e5e5]">Endpoint</h3>
              <div className="bg-[#111] p-3 rounded border font-mono text-xs text-violet-400">
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-[#e5e5e5]">Schema Coverage</h3>
              <div className="border rounded-md overflow-hidden divide-y">
                <div className="grid grid-cols-4 p-2.5 text-xs font-semibold bg-[#111] text-muted-foreground">
