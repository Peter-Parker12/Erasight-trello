...
import { RemoveCardMember } from "@/actions/manage-card-members/schema";
import type { RemoveInputType } from "@/actions/manage-card-members/types";
...
export const POST = toApiRoute(createSafeAction(RemoveCardMember, removeHandler as any));
