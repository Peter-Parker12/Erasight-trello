...
import { UpdateCardPriority } from "@/actions/update-card-priority/schema";
import { InputType, ReturnType } from "@/actions/update-card-priority/types";
...
export const POST = toApiRoute(createSafeAction(UpdateCardPriority, handler));
