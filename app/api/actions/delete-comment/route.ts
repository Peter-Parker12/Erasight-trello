...
import { DeleteComment } from "@/actions/delete-comment/schema";
import { InputType, ReturnType } from "@/actions/delete-comment/types";
...
export const POST = toApiRoute(createSafeAction(DeleteComment, handler));
