...
import { DeleteChecklistItem } from "@/actions/delete-checklist-item/schema";
import { InputType, ReturnType } from "@/actions/delete-checklist-item/types";
...
export const POST = toApiRoute(createSafeAction(DeleteChecklistItem, handler));
